...
public static class Program
{
    ...
    {
	    Console.WriteLine("Updating assembly version number.");

        // args[0]: The target directory path (optional).
        var dirPath = args.Length > 0 ? args[0] : ".";
		//var dirPath = @"C:\Users\declan.taylor\OneDrive - ChartCo Ltd\Documents\Visual Studio 2015\Projects\Master\WPFUtility";
